...
## 1.0
A vote App based on open source project MVVMHabit

Reference : https://github.com/goldze/MVVMHabit
...
<layout>
    <data>
        <variable
            type="com.payouth.hackathon.vote.login.ui.mvvmhabit.LoginViewModel"
            name="viewModel"
        />
    </data>
    .....
